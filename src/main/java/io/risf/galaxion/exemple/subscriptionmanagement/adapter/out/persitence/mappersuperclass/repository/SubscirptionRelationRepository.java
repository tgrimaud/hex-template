...
import io.risf.galaxion.exemple.subscriptionmanagement.adapter.out.persitence.mappersuperclass.model.SubscriptionMSCRelation;
import org.springframework.context.annotation.Profile;
import org.springframework.data.jpa.repository.JpaRepository;

@Profile("mappersuperclass")
public interface SubscirptionRelationRepository extends JpaRepository<SubscriptionMSCRelation, RelationMSCId> {
}